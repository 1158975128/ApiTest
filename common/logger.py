...
class MyLogging:
    def __init__(self, logger=None):
        ...
        filename = lib_path + '/' + logger + '_' + timestr + '.log'  # 日志文件地址
        self.logger = logging.getLogger(logger)  # 定义对应的程序模块名name，默认为root
        self.logger.setLevel(logging.INFO)  # 必须设置，这里如果不显示设置，默认过滤掉warning之前所有级别的信息
