...
public class SmsUtil {
	...
	static final String accessKeyId = "LTAI4GBujTdZWxMxANf2N6cr";
	static final String accessKeySecret = "vIPbYRdZadFdQ9YnTUDV7qqaJa0aWp";
	...
	public static SendSmsResponse sendSms(String phone, int code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("傅利叶智能");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_155845041");
...
//        request.setOutId("yourOutId");
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
		...
		// 必填-号码
		request.setPhoneNumber("17368038487");
		// 可选-流水号
	...
	public static void main(String[] args) throws ClientException, InterruptedException {
		...
		// 发短信
		SendSmsResponse response = sendSms("18755469598", 852654);
