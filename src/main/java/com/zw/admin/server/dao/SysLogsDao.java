...
public interface SysLogsDao {
	...
	@Insert("insert into sys_logs(userId, module, flag, remark, createTime,username,method,params,time,ip) " +
			"values(#{user.id}, #{module}, #{flag}, #{remark}, now(),#{username},#{method},#{params},#{time},#{ip})")
