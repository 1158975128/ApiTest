...
class Patient_Info_Modify():
    ...
    def modify_info(self,patient_name):
        self.patient.go_to_patient()
        time.sleep(3)
        ...
        if patient_name == check_name.text:
            check_name.click()
            patient_info = self.version.getLocator(self.driver, "Patient_Info")
            patient_info.click()
            time.sleep(1)
            info_modify = self.version.getLocator(self.driver, "Info_Modify")
            info_modify.click()
            time.sleep(1)
