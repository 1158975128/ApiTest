...
class TestDisease():
    ...
    def test_01_disease_page(self,new_additional,position,create_time,modification_time,operation,driver):
        '''
        验证疾病类型页格式正确
        '''
        self.type = Disease_Type(driver)
    ...
    def test_02_add_position(self,disease,driver):
        '''
        测试新增疾病类型
    ...
    def test_03_modify_position(self,disease,modify_disease,driver):
        '''
        测试修改疾病类型
    ...
    data = [("测试删除新增疾病类型")]
    @pytest.mark.parametrize('disease',data)
    def test_04_delete_disease(self,disease,driver):
        '''
        测试新增疾病类型
        :param disease: 新增疾病类型名
        '''
