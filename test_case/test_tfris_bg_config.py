...
def login(driver):
    ...
    mylogin.login_fris('admin','冒烟测试机构90')
    yield
...
class TestTreat:
    ...
    @pytest.mark.parametrize('email,email_pwd,email_type,name,sex,phone,pwd,con_pwd,office,depar,title,job,job_type,role', [('jssdezyy027@163.com','jssdezyy123','163','医生2','男','18389683001','abc123456@','abc123456@','骨科', '住院','住院医师','医生','OTPT传统','康复医生'),
                                                                                                                            ('jssdezyy028@163.com','jssdezyy123','163','刘玉栋-治疗师','男','18389683002','abc123456@','abc123456@','康复科', '门诊','康复治疗士','治疗师','PT','治疗师'),
                                                                                                                            ('jssdezyy029@163.com','jssdezyy123','163','OT治疗师2','女','18389683003','abc123456@','abc123456@','康复科', '门诊','康复治疗士','治疗师','OTPT传统','治疗师'),
                                                                                                                            ('jssdezyy030@163.com','jssdezyy123','163','刘玉栋-治疗师长','女','18389683005','abc123456@','abc123456@','康复科', '门诊','副主任康复师','治疗师','OTPTST传统','治疗师长')])
