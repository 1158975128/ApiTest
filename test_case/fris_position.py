...
class TestPosition():
    ...
    def test_01_positio_page(self,new_additional,position,create_time,modification_time,operation,driver):
        '''
        验证职务页格式正确
        '''
        self.posion = Position(driver)
    ...
    def test_02_add_position(self,position,driver):
        '''
        测试新增职务
    ...
    def test_03_modify_position(self,position,modify_position,driver):
        '''
        测试修改职务
    ...
    def test_04_delete_position(self,delete_position,driver):
        '''
        测试删除职务
